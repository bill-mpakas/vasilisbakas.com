...
const images = [
	{
		alt: 'Gazing Matterhorn',
		imageUrl: '/assets/images/matterhorn.jpg',
	},
	{
		alt: 'Stockholm',
		imageUrl: '/assets/images/stockholm.png',
	},
	{
					...
					<div class="relative px-4 sm:px-8 lg:px-12">
						<div class="mx-auto max-w-2xl lg:max-w-5xl">
							<div class="text-pretty">
								<h1 class="text-4xl font-bold leading-8 tracking-tight text-zinc-800 sm:text-5xl">
								...
								<p class="mt-6 text-xl leading-8 xl:text-2xl text-zinc-600">
									...
									<a target="_blank" class="hover:underline" href="https://www.pointer.gr/en">Pointer.gr</a>
									while pursuing my Master's degree in Strategic Product Design.
								</p>
								<div class="mt-6 flex gap-6">
									<a v-for="link in socialLinks" :key="link.ariaLabel" class="group -m-1 p-1"
										:aria-label="link.ariaLabel" :href="link.href">
