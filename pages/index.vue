	...
	<main>
		<section class="py-12" id="intro">
			<div class="sm:px-8 mt-9">
				<div class="container mx-auto w-full max-w-7xl lg:px-8">
					<div class="relative px-4 sm:px-8 lg:px-12">
						<div class="mx-auto max-w-2xl lg:max-w-5xl">
							<div class="max-w-2xl">
								...
								<p
									class="mt-6 text-base xl:text-lg text-zinc-600 dark:text-zinc-400"
								>
									I’m a User Interface developer based in Thessaloniki. I'm
								...
								<div class="mt-6 flex gap-6">
									<a
										...
										><svg
											viewBox="0 0 24 24"
											aria-hidden="true"
											class="h-8 w-8 fill-zinc-500 transition group-hover:fill-zinc-600 dark:fill-zinc-400 dark:group-hover:fill-zinc-300"
										>
											<path
