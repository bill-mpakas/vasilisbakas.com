            ...
            <div class="flex flex-row justify-between gap-2">
              ...
              <div>
                ...
                <div class="flex flex-col gap-1">
                  ...
                  <small class="text-sm lg:text-base italic text-gray-600"
                    >Grade:{{ school.grade }}</small
                  >
                </div>
                <!-- Info - Description -->
                <div
...
const skills = [
  ...
  },
  {
    ...
    description:
      'Experience in creating and maintaining a living style guide and design system - Professional knowledge of Figma.',
  },
  {
    title: 'Interaction design',
    description:
      'Proficient in using data to drive design decisions and present findings as concepts.',
  },
  {
    title: 'Qualitative research',
    description:
      'Extensive experience in qualitative research, including interviews, usability tests, and personas.',
  },
  {
    title: 'Visual design',
    description:
  ...
  },
  {
    title: 'Accessibility',
    description:
      'Experienced in designing inclusive products and conducting accessibility evaluations.',
  },
];
</script>
